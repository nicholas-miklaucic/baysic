"""Benchmarking code. A trimmed and simplified version of
https://github.com/usccolumbia/CSPBenchMetrics/blob/main/code/distance_single.py, to whom all credit is due."""
...
#energy distance
def en_dist(s1, s2):
    # s_gt = Structure.from_file(cif_gt)
    # s_pred = Structure.from_file(cif_pred)
    s_gt=s1
    s_pred=s2
